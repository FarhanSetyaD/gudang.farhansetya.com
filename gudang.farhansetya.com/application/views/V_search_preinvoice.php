...
<body>
  ...
  <div style="margin-top: 20px" class="ui grid container">
    <div class="row">
      <p style="font-size: 30px; font-weight: bold">SEARCH PRE-INVOICE</p>
    </div>
    <!--form-->
    <form method="POST" action="Pre_invoice/search">
    <!--2-6-->   
      ...
      <div style="padding: 20px;
        ...
        <div class="inline fields">
          ...
          <div class="seven wide field">
            <select class="ui search dropdown" name="nomor_host">
            <!--<input type="text" name="nomor_host">-->
            <?php 
                if ( ! empty($dropdown)){ ?>
              <!--<datalist>-->
                <?php foreach($dropdown as $item){ ?>
                <option value="<?php echo $item["POS_NO"];?>"><?php echo $item["POS_NO"];?></option>
                <?php } ?>
              <!--</datalist>-->
            <?php } ?>
