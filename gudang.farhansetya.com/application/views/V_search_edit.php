...
<body>
  ...
  <div style="margin-top: 20px" class="ui grid container">
    <div class="row">
      <p style="font-size: 30px; font-weight: bold">SEARCH EDIT</p>
    </div>
    <!--form-->
    <form method="POST" action="Edit/search">
    <!--2-6-->   
    <div class="row ui form">
      <div style="padding: 20px;
        ...
        <div class="inline fields">
          <label style="width: 130px;">NOMOR MASTER BL (MBL_NO)</label>
          <div class="seven wide field">
            <select class="ui search dropdown" name="nomor_master">
            <!--<input type="text" name="nomor_host">-->
            <?php 
                if (!empty($dropdown)){ ?>
              <!--<datalist>-->
                <?php foreach($dropdown as $item){ ?>
                <option value="<?php echo $item["MBL_NO"];?>"><?php echo $item["MBL_NO"];?></option>
                <?php } ?>
              <!--</datalist>-->
            <?php } ?>
    ...
    <!--        <div class="seven wide field">-->
    <!--          <input type="text" name="nomor_master" disabled>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--    <div class="inline fields">-->
    <!--        <label style="width: 130px;">NOMOR CONTAINER</label>-->
    <!--        <div class="seven wide field">-->
    <!--          <input type="text" name="nomor_container" disabled>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--    <div class="inline fields">-->
    <!--        <label style="width: 130px;">NAMA KAPAL</label>-->
    <!--        <div class="seven wide field">-->
    <!--          <input type="text" name="nama_kapal" disabled>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--    <div class="inline fields">-->
    <!--        <label style="width: 130px;">NAMA CONSIGNEE</label>-->
    <!--        <div class="seven wide field">-->
    <!--          <input type="text" name="nama_consignee" disabled>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--    <div class="inline fields">-->
    <!--        <label style="width: 130px;">NPWP</label>-->
    <!--        <div class="seven wide field">-->
    <!--          <input type="text" name="npwp" disabled>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--    <div class="inline fields">-->
    ...
    <!--        <div class="seven wide field">-->
    <!--          <input type="text" name="gross" disabled>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--    <div class="inline fields">-->
    <!--        <label style="width: 130px;">PRE-INVOICE STATUS</label>-->
    <!--        <div class="seven wide field">-->
    <!--          <input type="text" name="preinvoice_status" disabled>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--    <div class="inline fields">-->
    ...
    <!--    </div>-->
        <div style="padding-bottom: 20px" class="row">
          <button class="ui primary button" type="submit" name="submit">Search</button>
        </div>
      </div>
      </form>
    </div>
